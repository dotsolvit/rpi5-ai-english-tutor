...
Асинхронний легкий (мінімалістичний) Telegram-бот, що працює на **Raspberry Pi 5** та виконує роль особистого репетитора з розмовної англійської мови. Проєкт побудований на базі OpenAI Whisper та GPT-4o-mini, використовує чистий асинхронний аудіо-конвеєр `ffmpeg` та має вбудований трекер витрат з наростаючим підсумком.
